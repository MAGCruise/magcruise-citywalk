                  ...
                  function(checkpoint) {
                    ...
                    checkpoint.tasks
                            .forEach(function(task, index) {
                              if (!(checkpoint.id in answerDic)
                                      || !(task.id in answerDic[checkpoint.id])) { return; }
                              if (task.taskType === "DescriptionTask") {
                                answerHtml += '問題：' + task.label + '<br/>正解：'
                                        + task.answerTexts.join('、') + '<br/>回答：'
                    ...
                    var html = '<div class="row checkpoint">'
                            ...
                            + '<p class="name">' + checkpoint.name + resultHtml + '</p>'
                            + '<p class="answer">' + answerHtml + '</p>' + '<img src="' + imgSrc
                            ...
                            + (checkpoint.description || "") + '</p>' + '</div>' + '</div>';
